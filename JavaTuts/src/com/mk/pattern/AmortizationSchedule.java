...
public class AmortizationSchedule
{
	...
	private double apr = 0d;//annual percentage rate
	...
	public void outputAmortizationSchedule()
	{
		...
		printf(formatString, "PaymentNumber", "PaymentAmount", "PaymentInterest", "CurrentBalance", "TotalPayments",
				"TotalInterestPaid");
		...
		printf(formatString, paymentNumber++, 0d, 0d, ((double) amountBorrowed) / 100d,
		...
		while ((balance > 0) && (paymentNumber <= maxNumberOfPayments))
		{
			...
			// output is in dollars
			printf(formatString, paymentNumber++, ((double) curMonthlyPaymentAmount) / 100d,
	...
	public AmortizationSchedule(double amount, double interestRate, int years) throws IllegalArgumentException {
		...
		if ((isValidBorrowAmount(amount) == false) || (isValidAPRValue(interestRate) == false)
	...
	public static void main(String[] args)
	{
		...
		String[] userPrompts = { "Please enter the amount you would like to borrow: ",
